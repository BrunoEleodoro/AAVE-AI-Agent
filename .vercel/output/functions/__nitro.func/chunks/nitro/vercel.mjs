...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/bruno/Documents/GitHub/AAVE-AI-Agent/.data/kv"}));
...
const _lazy_iKZGtA = () => import('../_id_.get.mjs');
const _lazy_3yp0Fo = () => import('../index.mjs');

const handlers = [
  { route: '/address/:id', handler: _lazy_iKZGtA, lazy: true, middleware: false, method: "get" },
  { route: '/', handler: _lazy_3yp0Fo, lazy: true, middleware: false, method: undefined }
];
