...
`
  ...
  return { balance: formatEther(balance), filteredAAVETokens, res:'get the ETHUSD and multiply by the WETH and balance the user has to show it in dollars', ETHUSD , address, error, accountData}
  }else {
    return {error};
  }
})
